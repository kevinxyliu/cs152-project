...
/* This is a structure that defines a moving direction. (0,1) means a 
 * direction to the right, (1,0) means a direction to the bottom, (1,1) 
 * means a direction to the bottom right,and (1,-1) means a direction to 
 * the bottom left */
struct dir {
    unsigned int r;
    unsigned int c;
