...
void evidence_board_new()
{
    ...
    board* test_board_1 = board_new(4,BITS);
    board* test_board_2 = board_new(6,BITS);
    board* test_board_3 = board_new(8,BITS);
    board* test_board_4 = board_new(10,BITS);
...
void evidence_board_show()
{
    ...
    board* test_board_1 = board_new(10,BITS);
    board* test_board_2 = board_new(20,BITS);
    board* test_board_3 = board_new(40,BITS);
    board* test_board_4 = board_new(70,BITS);
    printf("- expecting a 10*10 empty board:\n");
    board_show(test_board_1);
...
void evidence_new_game()
{
    ...
    game* test_game_1 = new_game(4, BITS);
    game* test_game_2 = new_game(6, BITS);
    game* test_game_3 = new_game(8, BITS);
...
void evidence_game_over()
{
    ...
    game* test_game = new_game(4, BITS);
    unsigned int i;
    for (i = 0; i < 2; i++) {
